...
def robot_description_dependent_nodes_spawner(
    ...
    return [
        Node(
            ...
            name='robot_state_publisher_'+namespace_,
            output='screen',
...
def generate_launch_description():
    ...
    left_robot_ip=''; left_arm_id='fr3'; left_use_fake_hardware='true'; left_fake_sensor_commands='true'; left_load_gripper='true'; left_arm_prefix='left'; left_namespace='left'; left_xyz= '0 0.4 0'; left_index='0'
